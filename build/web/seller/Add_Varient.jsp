                      ...
                      <div class="formSep">
                                                                 ...
                                                                 <div class="w-box" id="n_datepicker">
                                                                   <div class="row-fluid">
                                                                       ...
                                                                       %>
                                                                       <input class="span12"  data-date-format="dd/mm/yyyy" id="datePick1" type="date" name="Special_price_from_date2" value="<%= formattedDate %>" >
                                                                   </div>
                                                                 </div> 
                                                             </div>	
                                                                    <div class="formSep">
                                                                 ...
                                                                 <div class="w-box" id="n_datepicker">
                                                                  <div class="row-fluid">
                                                                    <input class="span12"  data-date-format="dd/mm/yyyy" id="datePick2" type="date" name="Special_price_to_date1"  >
                                                                      </div>
                                                                 </div> 
                                                                 </div>	
                      <div class="formSep">
                   ...
                   <!--/////////////////////////////////Dynamic///////////////////////////////////////////-->
                     <div class="span6">
                         <%
                                   ...
                                   DBCollection collection10 = db1.getCollection(Seller_Login.Product_collection);
