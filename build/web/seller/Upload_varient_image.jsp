                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="w-box w-box-blue">
                             <form action='Upload_Seller_varient_image' method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="span8">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <span class="btn btn-small btn-file">
                                                ...
                                                <input type="file" id='PAN_file' name='PAN_file' required accept="image/jpeg" onchange="validateImage(this.id);" ></span>
