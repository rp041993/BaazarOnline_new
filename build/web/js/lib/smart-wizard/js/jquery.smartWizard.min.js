...
"#abc").attr("id","next").addClass("btn buttonNext"),previous:$("<a>"+e.labelPrevious+"</a>").attr("href","#").attr("id","prev").addClass("btn buttonPrevious"),finish:$('<button type="submit">'+e.labelFinish+"</button>").attr("href","#").attr("id","save").addClass("btn btn-inverse buttonFinish")};var g=function(a,c){return $($(c,a.target).attr("href").replace(/^.+#/,"#"),a.target)},h=function(a,c){var d=a.steps.eq(c),b=a.options.contentURL,e=a.options.contentURLData,f=d.data("hasContent"),i=c+1;b&&0<b.length?a.options.contentCache&&f?j(a,c):(b={url:b,type:"POST",
