...
<!--            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-serialize-object/2.5.0/jquery.serialize-object.min.js">
    ...
    <!-- aditional stylesheets -->
        ...
        <!-- common functions -->
           ...
           <link href="../js/lib/smart-wizard/styles/smart_wizard.css" rel="stylesheet" type="text/css"/><html>
       <body >
           <!-- breadcrumbs -->
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="w-box w-box-blue">
                             <form action='Upload_Seller_product_image' method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="span8">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <span class="btn btn-small btn-file">
                                                ...
                                                <input type="file" id='PAN_file' name='PAN_file' accept="image/jpeg" required onchange="validateImage(this.id);"></span>
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <span class="btn btn-small btn-file">
                                                <span class="fileupload-new">Select image</span>
                                                <span class="fileupload-exists">Change</span>
                                                <input type="file" id='TIN_file' name='TIN_file'accept="image/jpeg" onchange="validateImage(this.id);"></span>
                                            <a href="#" class="btn btn-small btn-link fileupload-exists" data-dismiss="fileupload">Remove</a>
                                        </div>
                                        </div>
                                        <!--/////////////////////////////////////////////////////////////////-->
                                        <div class="formSep">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 60px; height: 60px;" id="image">
                                               <img src="../img/No_image.gif" alt="" id="image">
                                            </div>
                                            <div class="fileupload-preview fileupload-exists thumbnail" style="width: 60px; height: 60px;"></div>
                                            <span class="btn btn-small btn-file">
                                                <span class="fileupload-new">Select image</span>
                                                <span class="fileupload-exists">Change</span>
                                                <input type="file" id='CST_file' name='CST_file' accept="image/jpeg" onchange="validateImage(this.id);" ></span>
                                            <a href="#" class="btn btn-small btn-link fileupload-exists" data-dismiss="fileupload">Remove</a>
                                        </div>
                                    </div>
                                    <!--/////////////////////////////////////////////////////////////-->    
                                    <div class="formSep">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <span class="btn btn-small btn-file">
                                                <span class="fileupload-new">Select image</span>
                                                <span class="fileupload-exists">Change</span>
                                                <input type="file" id='Gumasta_file' name='Gumasta_file' accept="image/jpeg" onchange="validateImage(this.id);" ></span>
                                            <a href="#" class="btn btn-small btn-link fileupload-exists" data-dismiss="fileupload">Remove</a>
                                        </div>
                                    </div>
                                            <!--/////////////////////////////////////////-->
...
var formData = new FormData();
    ...
    if (t != "jpeg" && t != "jpg" ) {
        alert('Image file extention should be jpg');
        window.location.href="Upload_product_image.jsp";
        return false;
    }
            ...
            reader.onload = function (e) {
                ...
                image.onload = function () {
                    ...
                    if (height != 1615 && width != 1200) {
                        alert('Image Resolution should be 1200*1615');
                        window.location.href="Upload_product_image.jsp";
                        return false;
                    }
                };
