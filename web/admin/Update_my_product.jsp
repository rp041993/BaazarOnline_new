    ...
    <body>
        ...
        if(i.equals("m"))
        {
          ...
          Mongo mg = new Mongo( ip ,27017);
            ...
            DBCollection collection = db.getCollection("product_prices");
            DBObject by_P_id = new BasicDBObject("Product_id", Product_id);  
                DBObject by_User_ID = new BasicDBObject("User_Object_ID", "amit25parmars@gmail.com");    
          ...
          %>
          <form action="Update_my_product" method="Post">
         ...
         <div class="formSep">
                                                    ...
                                                    <div class="w-box" id="n_datepicker">
                                                      <div class="row-fluid">
                                                          ...
                                                          %>
                                                          <input class="span10"  data-date-format="dd/mm/yyyy" id="datePick1" type="date" name="Special_price_from_date" value="<%= formattedDate %>" >
                                                      </div>
                                                    </div> 
                                                </div>	
                                                       <div class="formSep">
                                                    ...
                                                    <div class="w-box" id="n_datepicker">
                                                     <div class="row-fluid">
                                                       <input class="span10"  data-date-format="dd/mm/yyyy" id="datePick2" type="date" name="Special_price_to_date"  >
                                                         </div>
                                                    </div> 
                                                    </div>	
         <div class="formSep">
