...
@WebServlet(urlPatterns = {"/Upload_Seller_product_image"})
public class Upload_Seller_product_image extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String Product_ID=(String)session.getAttribute("c_p_id");
...
//                        String root=root1.replace("/build/web/", "/web/");
                        ...
                        if(!fileName.equals("")){
                           ...
                           if(s1=="T")
                           {
                             ...
                             //   create a blank, RGB, same width and height, and a white background
                               ...
                               // write to jpeg file
                                System.out.println("image ==================="+outputfile);
        ...
        catch(Exception e)
        {
                ...
                rs.include(request, response);
                out.print("<script>alert('Error Occurred');</script>");
        }
  }
