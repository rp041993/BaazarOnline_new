...
@WebServlet(urlPatterns = {"/sellerProductAjax"})
public class sellerProductAjax extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String  Product_Name=request.getParameter("val");
    ...
    DBObject str=cursor.next();
     if(str.get("Product_Name").equals(Product_Name))
     {
