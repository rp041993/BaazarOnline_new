...
@WebServlet(name = "last_child_category_for_show_product", urlPatterns = {"/last_child_category_for_show_product"})
public class last_child_category_for_show_product extends HttpServlet {
                   ...
                   while(cursor1.hasNext())
                          ...
                          Last_child1.add(cid);
                                   ...
                                   HttpSession session = request.getSession(true);
                                    session.setAttribute("Last_child_id_for_show_product",Last_child1);
