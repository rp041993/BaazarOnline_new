 ...
 * @author baazarteam4
 */
@WebServlet(name = "AddAtributeSet", urlPatterns = {"/AddAtributeSet"})
public class AddAtributeSet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response);
         ...
         String [] check = request.getParameterValues("multiple");
          ...
          if (CheckAtt.checkAttributeSet(Name)) {
              ...
              try {
                  ...
                  doc.put("attset", "AttributeSet");
                  doc.put("Name", Name);
                  doc.put("Attributes", check);
    ...
    out.print("<script>alert('success');</script>");
     ...
     out.print("<script>alert('Attribute set is already existe');</script>");
         RequestDispatcher rs = request.getRequestDispatcher("showAttribute.jsp");
                rs.include(request, response);
