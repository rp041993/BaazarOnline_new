...
@WebServlet(urlPatterns = {"/Upload_varient_image"})
public class Upload_varient_image extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.print("999999999"+Add_Varient.c_varient_id);
        try  {
...
String ip = getServletContext().getInitParameter("ip");           
            String Product_ID=Add_Varient.c_varient_id;
                    ...
                    if (!item.isFormField()) {
                        ...
                        if(!fileName.equals("")){
                           ...
                           if(s1=="T")
                           {
                              ...
                              bufferedImage = ImageIO.read(new File(getServletContext().getRealPath("/img/product/"+fileName)));

                             //   create a blank, RGB, same width and height, and a white background
                               BufferedImage newBufferedImage = new BufferedImage(bufferedImage.getWidth(),
                                             bufferedImage.getHeight(), BufferedImage.TYPE_INT_RGB);
                               newBufferedImage.createGraphics().drawImage(bufferedImage, 0, 0, Color.WHITE, null);
                               File outputfile = new File(getServletContext().getRealPath("/img/product").concat("/").concat(New_img_name));
                               // write to jpeg file
                               ...
                               System.out.println("Done");
                                File inputfile = new File(getServletContext().getRealPath("/img/product").concat("/").concat(fileName));
                               inputfile.delete();
