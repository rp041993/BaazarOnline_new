...
public class Update extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            /* TODO output your page here. You may use following sample code. */
             out.print("<script> alert('update sucusses');"
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String DefautV = request.getParameter("Default_Value");
        ...
        String options = request.getParameter("opt1");
        System.out.println("Cnamesv  "+options);
   
         List<String> values = Arrays.asList(options.split(",")); 
          System.out.println("list as arrys as list  "+values);
